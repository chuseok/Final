...
<body>
	...
	<div class="HomeLayout">
		<div class="HomeLayout-container">
            ...
            <form id="foldersearchForm" action="/folders/list" method="get">
               ...
               <div class="lat">   
							<div class="ProfileFoldersPage">
								...
								<div class="DashboardListItem">
									...
									<a href="/folders/get?folderId=<c:out value='${folder.folderId }'/>&userId=${currentUserName }">
									<div class="UILinkBox">
        ...
        <form id='actionForm' action='/folders/list' method='get'>
        	<input type='hidden' name='pageNum' value='${pageMaker.cri.pageNum }'>
        	<input type='hidden' name='amount' value='${pageMaker.cri.amount }'>
...
<!-- 	<script>
	...
	$(document).ready(function(){
		...
		$("#regBtn").on("click", function(){
			self.location="/folders/register";
		});
